...
public class ColorCube {
	...
	public ColorCube(float size, int color) {
		this(size, 0.0f, 0.0f, 0.0f, color);
	}
	
	public ColorCube(float size, float x, float y, float z, int color) {
		setArrays(size, x, y, z, color);
	}
	
	private void setArrays(float size, float x, float y, float z, int color) {
		...
		float c = 1.0f;
		float r = ((color&0x00FF0000)>>4)/255.0f;
		float g = ((color&0x0000FF00)>>2)/255.0f;
